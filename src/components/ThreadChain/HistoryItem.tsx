    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            if (
                ...
                deleteConfirmationDialogRef.current &&
                !deleteConfirmationDialogRef.current.contains(event.target as Node)
            ) {
			...
			<div className="ow-list-item">
				<div className="ow-info">
					<div className="ow-title">
						...
						<div className={`ow-actions ${showDeleteConfirmation === true ? 'show' : ''}`}>
						...
						<div className={`ow-msg-count ${showDeleteConfirmation === true ? 'show' : ''}`}>
